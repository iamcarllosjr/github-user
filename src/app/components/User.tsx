    ...
    <div className="xl:flex xl:flex-col xl:px-4 space-y-3">
      <div className="flex gap-5 items-center">
        ...
        <div className="flex flex-col space-y-1 xl:space-y-0 text-xs xl:flex-row xl:gap-32 xl:ml-3">
          <div className="">
            <h2 className="mb-1 xl:mb-2 xl:text-base">
              {name ? (
                `${name}`
              ) : (
                <span className="text-gray-400">Name Not Available</span>
              )}
            </h2>
      ...
      <div>
        <p className="text-xs xl:ml-28 bio">
          {bio ? `${bio}` : <span className="text-gray-400">Bio Not Available</span>}
        </p>
      </div>
          ...
          <span>
            <a href={blog} target="_blank" className="flex gap-2">
              ...
              {blog ? (
                ...
                <span className="text-gray-400">Blog Not Available</span>
              )}
            </a>
          </span>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <span className="flex gap-2">
            ...
            {company ? (
              ...
              <span className="text-gray-400">Company Not Available</span>
            )}
          </span>
        </div>
      </div>
